...
log_in.click()
time.sleep(1)
link=driver.find_element(By.CLASS_NAME,'navigation-categories-ul').find_elements(By.CLASS_NAME,'navigation-categories-item')
for x in link :
    print(x) 
    x.click()
    time.sleep(1)
    ...
    while True:
        ...
        content = driver.find_elements(By.CLASS_NAME, "js_obasket_parents")
        # content2 = driver.find_element(By.CLASS_NAME, "PagedList-skipToNext").find_element(By.CLASS_NAME, 'js_pagelink')
        content3=driver.find_element(By.CLASS_NAME,"product-group-pagination").find_element(By.CLASS_NAME,'PagedList-skipToLast').find_element(By.CLASS_NAME,'js_pagelink')
        i=2   
        ...
        #     print("----------------------------------------------------------------")
        #     for ogeler in GenelList:
        #         urun_elem = ET.SubElement(kok, "Urun")
        #         for key, value in ogeler.items():
        #             urun_elem.set(key, str(value))
